...
const FormListScreen2 = ({ navigation }) => {
...
const formListOptions = ['Form List 1', 'Form List 2', 'Form List 3'];
  ...
  //         </head>
  //         <body>
  //           <h1>Driving Test Form-1 Submission</h1>
  ...
  //         </body>
  //       </html>`,
  //     fileName: 'Driving Test Form-1 Submission',
  //     directory: 'Documents',
  //   };
  ...
  // const createPDF = async (formDataArray) => {
  //   let options = {
  //     html: `
  //       <html>
  //         <head>
  ...
  // const createPDF = async (formData) => {
  //   let options = {
  //     html: '<h1>Driving Test Form-1 Submission</h1>' + Object.entries(formData).map(([key, value]) => `<p><strong>${convertCamelCaseToReadable(key)}:</strong> ${value}</p>`).join(''),
  //     fileName: 'Driving Test Form-1 Submission',
  //     directory: 'Documents',
  //   };
  ...
  const handleFormDownload = (form) => {
    const { formData, fieldOrder } = form;
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.heading}> Driving Test Form Submission</Text>
  ...
  <TouchableOpacity style={styles.selectionBtn} onPress={() => navigation.navigate('FormList3')}>
    ...
    <View style={styles.tableHeader}>
        ...
        <Text style={styles.headerCellMain}>Driving Test Form-1 Submissions</Text>
      </View>
...
export default FormListScreen2;